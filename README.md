...
메인 실행 파일  
`main_train.ipynb에서 생성한 모델 불러와서 전체 코드 정리한 곳`  
[test_copy.ipynb](https://github.com/game240/CutPaste/blob/main/jjs/test_copy.ipynb)  
...
[cutpaste.py](https://github.com/game240/CutPaste/blob/main/jjs/cutpaste.py)  
